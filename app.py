...
with left_col:
    ...
    T = st.slider("T: Time to Maturity (Years)", min_value=0.1, max_value=10.0, value=10.0 , step=0.1)
    N = st.number_input("N: Number of Time Steps", min_value=1.0, max_value=2000.0, value=12.0 , step=10.0)
